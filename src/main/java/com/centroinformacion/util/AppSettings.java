...
public class AppSettings {
	...
	public static final int CATALOGO_09_ESTADO_SALA= 9;
	public static final int CATALOGO_10_CENTRO_DE_ESTUDIOS = 10;
	public static final int CATALOGO_11_IDIOMA = 11;
	public static final int CATALOGO_12_TEMA_DE_TESIS = 12;
